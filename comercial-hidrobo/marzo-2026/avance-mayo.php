...
<div id="tab-avance" class="tab-content space-y-8">
    ...
    <div id="sub-avance-ok" class="sub-content">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate-300">
                        ...
                        <li class="flex gap-2"><span class="text-emerald-400">✓</span><div><strong>Google Tag Manager instalado en okcars.ec</strong> con los mismos eventos de conversión que en Comercial Hidrobo: <code class="text-xs bg-slate-800 px-1 rounded">whatsapp_click</code> (mide cada clic al botón de WhatsApp) y <code class="text-xs bg-slate-800 px-1 rounded">form_submit</code> (mide envíos de formularios). Ambos eventos verificados y disparándose en GA4.</div></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="rounded-xl border border-purple-500/30 bg-purple-500/5 p-6 mt-8">
            <h3 class="text-lg font-semibold text-white mb-4">Recomendaciones priorizadas para los próximos 30 días</h3>
            <ol class="space-y-3 text-sm text-slate-300">
                <li class="flex gap-3"><span class="flex-shrink-0 w-6 h-6 rounded-full bg-purple-600 text-white text-xs flex items-center justify-center font-bold">1</span><div><strong class="text-white">Optimizar el copy del home.</strong> Recibe el 40 % del tráfico orgánico: cualquier mejora en el llamado a la acción y en el primer scroll se multiplica directamente en leads.</div></li>
                <li class="flex gap-3"><span class="flex-shrink-0 w-6 h-6 rounded-full bg-purple-600 text-white text-xs flex items-center justify-center font-bold">2</span><div><strong class="text-white">Corregir las URLs antiguas /usados/ con redirección 301.</strong> Hoy generan errores 404 cuando alguien intenta visitarlas desde Google y se pierde la autoridad SEO acumulada.</div></li>
                <li class="flex gap-3"><span class="flex-shrink-0 w-6 h-6 rounded-full bg-purple-600 text-white text-xs flex items-center justify-center font-bold">3</span><div><strong class="text-white">Continuar el ritmo de 20 posts/mes.</strong> Los efectos SEO se ven entre 60 y 120 días después de publicar. El batch de junio ya está siendo planificado con base en los datos que estos primeros 20 generen.</div></li>
                <li class="flex gap-3"><span class="flex-shrink-0 w-6 h-6 rounded-full bg-purple-600 text-white text-xs flex items-center justify-center font-bold">4</span><div><strong class="text-white">Aprovechar el éxito del Deepal S05.</strong> Es la única ficha que ya posiciona orgánicamente; ese mismo patrón puede replicarse al resto del inventario optimizando títulos y meta descripciones de cada vehículo.</div></li>
                <li class="flex gap-3"><span class="flex-shrink-0 w-6 h-6 rounded-full bg-purple-600 text-white text-xs flex items-center justify-center font-bold">5</span><div><strong class="text-white">Configurar conversiones clave en GA4 ahora que GTM está activo.</strong> Marcar <code class="text-xs bg-slate-800 px-1 rounded">whatsapp_click</code> y <code class="text-xs bg-slate-800 px-1 rounded">form_submit</code> como eventos clave para empezar a medir tasa de conversión real desde el primer mes.</div></li>
            </ol>
        </div>
    </div>
</div>
