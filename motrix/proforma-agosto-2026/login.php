...
<style>
:root{
  --teal:#14b8a6; --teal-osc:#0d9488; --teal-claro:#5eead4;
  --noche:#0a0f16; --carbon:#111a24; --gris:#7d8fa3; --hielo:#cbd5e1;
}
*{box-sizing:border-box;margin:0;padding:0}
body{
  font-family:'Outfit',system-ui,sans-serif;
  background:radial-gradient(950px 640px at 28% 10%, rgba(20,184,166,.20), transparent 62%), var(--noche);
...
.caja{
  ...
  border:1px solid rgba(94,234,212,.16); border-radius:18px; padding:44px 38px;
  box-shadow:0 40px 90px rgba(0,0,0,.55);
}
.sello{
  width:60px;height:60px;margin:0 auto 20px;border-radius:16px;
  background:linear-gradient(135deg,var(--teal-osc),var(--teal));
  display:grid;place-items:center;
}
.sello svg{width:30px;height:30px;color:#032b26}
.eyebrow{
...
input{
  ...
  background:rgba(10,15,22,.7);border:1px solid rgba(94,234,212,.18);
  color:#e8eef6;font:inherit;font-size:14.5px;
}
input:focus{outline:none;border-color:var(--teal);box-shadow:0 0 0 3px rgba(20,184,166,.22)}
button{
  width:100%;margin-top:20px;padding:15px;border:0;border-radius:11px;
  background:linear-gradient(135deg,var(--teal-osc),var(--teal));
  color:#032b26;font:inherit;font-weight:700;font-size:14.5px;cursor:pointer;transition:filter .2s;
}
...
.pie{
  margin-top:26px;padding-top:20px;border-top:1px solid rgba(94,234,212,.12);
