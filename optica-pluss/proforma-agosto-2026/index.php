...
/* Secciones */
.sec{padding:58px 0;border-bottom:1px solid var(--linea)}
...
.card{background:rgba(13,36,55,.55);border:1px solid var(--linea);border-radius:16px;padding:22px 20px;
...
.plan{position:relative;background:rgba(13,36,55,.55);border:1px solid var(--linea);border-radius:18px;
...
.cta{margin-top:30px;background:linear-gradient(135deg,rgba(46,211,198,.14),rgba(0,117,201,.10));
  border:1px solid rgba(46,211,198,.35);border-radius:18px;padding:30px;text-align:center}
.cta h3{font-size:22px;margin-bottom:6px}
.cta p{color:var(--niebla);margin-bottom:16px}
.contacto{display:flex;flex-wrap:wrap;gap:12px 24px;justify-content:center;font-size:14.5px;color:var(--hueso)}
/* Footer */
...
@media (max-width:720px){
  .grid,.grid.g2,.cols,.planes{grid-template-columns:1fr}
...
.dl{display:inline-flex;align-items:center;gap:8px;margin-top:22px;padding:11px 20px;border-radius:11px;
  background:linear-gradient(135deg,var(--aqua),var(--aqua-osc));color:#04121a;font-weight:700;font-size:14px;
...
<section class="hero">
  <div class="wrap">
    ...
    <h1>Un solo sistema para tu &oacute;ptica:<br>pacientes, ex&aacute;menes, ventas e inventario</h1>
    <p class="lead">Deja el Excel y los formularios a mano. Toda la operaci&oacute;n de tus <strong>4 locales</strong> y tus <strong>2 RUCs</strong> en un solo lugar, con la ficha del paciente capturada una sola vez.</p>
    <div class="meta">
...
<section class="sec">
  <div class="wrap">
    <span class="tag">01 &middot; C&oacute;mo trabajas hoy</span>
    ...
    <div class="grid">
      <div class="card">
        <div class="ic">&#128203;</div>
        <h3>Tres formularios a mano</h3>
        <p>Ficha de ex&aacute;menes, recibo y orden de trabajo se llenan a mano, repitiendo los datos del cliente en cada uno.</p>
      </div>
      <div class="card">
        <div class="ic">&#128202;</div>
        <h3>Todo en Excel</h3>
        <p>Clientes, ventas e inventario en hojas de c&aacute;lculo separadas &mdash; sin conexi&oacute;n entre s&iacute; ni respaldo real.</p>
      </div>
      <div class="card">
        <div class="ic">&#128065;</div>
        <h3>Sin historial del paciente</h3>
        <p>No hay forma r&aacute;pida de ver las visitas y recetas anteriores de un paciente, ni de reusar su medida.</p>
      </div>
      <div class="card">
        <div class="ic">&#127970;</div>
        <h3>4 locales, 2 RUCs, sin vista &uacute;nica</h3>
        <p>Cada local y cada RUC por su lado. No hay un tablero que muestre las ventas de todos juntos.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec">
  <div class="wrap">
    ...
    <h2>Todo lo que necesita tu operaci&oacute;n</h2>
    <div class="cols">
      <div>
        ...
        <ul class="li ok-li">
          ...
          <li>Facturaci&oacute;n electr&oacute;nica SRI (por cada RUC).</li>
      ...
      <div>
        ...
        <ul class="li no-li">
          <li>Certificado de firma electr&oacute;nica (lo emite el cliente: Security Data / BCE, ~$25&ndash;40/a&ntilde;o).</li>
...
<section class="sec alt">
  <div class="wrap">
    ...
    <h2>Elige c&oacute;mo empezar</h2>
    <p class="p">Dos formas de arrancar. La diferencia es la <strong>lectura autom&aacute;tica de los tickets con inteligencia artificial</strong>: subes la foto del examen computarizado y del lens&oacute;metro, y el sistema llena la receta solo &mdash; el opt&oacute;metra la revisa y confirma. Probamos con tus propios tickets y la lectura sali&oacute; exacta.</p>
    <div class="planes">
      <div class="plan pop">
    ...
    <div class="cuadro">
      ...
      <div class="fila"><span>Suscripci&oacute;n mensual (Quipuy, 4 locales / 2 RUCs)</span><strong>$60 / mes + IVA</strong></div>
      <div class="fila"><span>Lectura con IA (solo opci&oacute;n con IA)</span><strong>al costo real, con informe mensual</strong></div>
    </div>
    <p class="nota">Todos los valores est&aacute;n en d&oacute;lares y <strong>no incluyen IVA</strong>. La lectura con IA se factura seg&uacute;n el uso real (referencia: ~1 centavo por examen); cada mes recibes un informe con la cantidad de lecturas y su costo.</p>
  </div>
</section>
...
<section class="sec">
  <div class="wrap">
    ...
    <h2>Qu&eacute; pagas mes a mes (y qu&eacute; no)</h2>
    <div class="grid g2">
      <div class="card">
        <h3>Suscripci&oacute;n Quipuy &mdash; $60/mes + IVA</h3>
        <p>Los 4 locales y los 2 RUCs, con todos los m&oacute;dulos: facturaci&oacute;n, inventario, apartados y &oacute;ptica. Sin costo mensual extra por el m&oacute;dulo.</p>
      </div>
      <div class="card">
        <h3>Lectura con IA &mdash; al costo</h3>
        <p>Solo si eliges la opci&oacute;n con IA. Se cobra lo que consume la inteligencia artificial (~$2&ndash;4 al mes por local seg&uacute;n el volumen), con informe transparente.</p>
      </div>
      <div class="card">
        <h3>Certificado de firma &mdash; lo renuevas t&uacute;</h3>
        <p>Cada RUC usa su certificado electr&oacute;nico (Security Data / BCE, ~$25&ndash;40/a&ntilde;o). No es un cobro de Creative Web.</p>
      </div>
      <div class="card">
        <h3>Facturaci&oacute;n por RUC</h3>
        <p>Por norma del SRI, cada RUC factura y numera por separado. El sistema lo unifica para <em>ver</em> y gestionar, pero cada comprobante sale bajo el RUC de su local.</p>
      </div>
    </div>
  </div>
</section>
...
<section class="sec alt">
  <div class="wrap">
    ...
    <div class="timeline">
      <div class="ti"><span class="w">Semana 1</span><p>Configuraci&oacute;n de las 2 empresas (RUCs) y los 4 locales, carga del cat&aacute;logo e inventario, certificados de firma.</p></div>
      <div class="ti"><span class="w">Semanas 2&ndash;3</span><p>M&oacute;dulo &oacute;ptica: ficha, receta, orden de trabajo y panel del due&ntilde;o. Lectura de tickets con IA (si aplica).</p></div>
      <div class="ti"><span class="w">Semana 4</span><p>Capacitaci&oacute;n al personal de los locales y puesta en marcha.</p></div>
    </div>
    <div class="need">
      <h4>Para arrancar necesitamos de ti</h4>
      <ul class="li ok-li">
        <li>Los 2 certificados de firma (.p12) con sus claves.</li>
        <li>El cat&aacute;logo e inventario actual (tus Excel).</li>
...
<section class="sec">
  <div class="wrap">
    <span class="tag">07 &middot; Con qui&eacute;n trabajas</span>
    ...
    <div class="cta">
      ...
      <p>Cuando confirmes la opci&oacute;n, preparamos la configuraci&oacute;n de tus 2 RUCs y coordinamos la carga de datos.</p>
      <div class="contacto">
        <span>&#128241; WhatsApp 0999174980</span>
        <span>&#9993;&#65039; info@creativeweb.com.ec</span>
      </div>
    </div>
  </div>
</section>
