...
.cliente-name{display:flex;align-items:center;gap:13px;margin-bottom:24px}
.cliente-name .ojo2{width:46px;height:46px;border-radius:50%;
...
.cliente-name .ctxt{display:flex;flex-direction:column;line-height:1.12}
.cliente-name .ctxt b{font-size:23px;font-weight:800;letter-spacing:-.01em;color:var(--hueso)}
.cliente-name .ctxt small{font-size:12.5px;color:var(--niebla);letter-spacing:.02em}
</style>
</head>
<body>
...
<section class="hero">
  <div class="wrap">
    <div class="cliente-name">
      <span class="ojo2">&#128065;</span>
      <span class="ctxt"><b>&Oacute;ptica Pluss</b><small>Todo un mundo por ver</small></span>
    </div>
