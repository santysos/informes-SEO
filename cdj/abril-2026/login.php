...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $pass = $_POST['password'] ?? '';
    if ($pass === 'CDJ-Jean-2026') {
        $_SESSION['auth_cdj'] = true;
...
<title>Auditoria de Marketing Digital — CDJ La Casa del Jean</title>
...
<div class="relative z-10 w-full max-w-md px-6">
    <div class="glass-card glow-ring rounded-2xl p-8 md:p-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-xl font-bold text-white mb-1">Auditoria de Marketing Digital</h1>
            <p class="text-slate-400 text-sm font-medium">CDJ La Casa del Jean — Ecuador</p>
        </div>
