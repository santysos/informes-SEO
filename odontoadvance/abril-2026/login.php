...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $pass = $_POST['password'] ?? '';
    if ($pass === 'OdAdv-2026') {
        $_SESSION['auth_odontoadvance'] = true;
...
<title>Informe Marketing Digital — OdontoAdvance</title>
...
<div class="relative z-10 w-full max-w-md px-6">
    <div class="glass-card glow-ring rounded-2xl p-8 md:p-10">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm font-medium">OdontoAdvance — Clinica Dental</p>
        </div>
