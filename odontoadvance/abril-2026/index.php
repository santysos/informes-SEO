...
<div id="tab-resumen" class="tab-content active">
    ...
    <div class="glass rounded-2xl p-6 mb-8">
        <div class="flex items-start gap-3">
            ...
            <div>
                <h3 class="text-white font-semibold mb-2">Pero primero... Que es "SEO" y por que le importa a su clinica?</h3>
                <p class="text-slate-400 text-sm leading-relaxed mb-3"><strong class="text-white">SEO</strong> significa "Search Engine Optimization" (Optimizacion para Motores de Busqueda). En palabras simples: <strong class="text-white">es el proceso de hacer que su sitio web aparezca en los primeros resultados de Google cuando alguien busca un dentista o un servicio dental.</strong></p>
                <p class="text-slate-400 text-sm leading-relaxed mb-3">Pienselo asi: cuando alguien tiene dolor de muelas o quiere ponerse brackets, lo primero que hace es buscar en Google "dentista cerca de mi" o "ortodoncia Quito". Si su clinica no aparece en la primera pagina, <strong class="text-white">ese paciente termina agendando con su competencia.</strong></p>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
                    ...
                    <div class="glass-lighter rounded-lg p-3">
                        ...
                        <p class="text-slate-400 text-[11px] leading-relaxed">El 75% de las personas nunca pasa de la primera pagina de Google (fuente: Backlinko). Si su clinica esta en la pagina 2 o mas abajo, practicamente no existe para los pacientes que buscan servicios dentales.</p>
                    </div>
                    <div class="glass-lighter rounded-lg p-3">
                        <p class="text-cyan-400 font-bold text-xs mb-1">Cual es el beneficio?</p>
                        <p class="text-slate-400 text-[11px] leading-relaxed">A diferencia de la publicidad pagada (que deja de funcionar cuando deja de pagar), el SEO genera pacientes GRATIS y de forma permanente. Cada mejora se acumula con el tiempo — es una inversion, no un gasto.</p>
                    </div>
                </div>
            </div>
        </div>
...
<div id="tab-inversion" class="tab-content">
    ...
    <div class="bg-gradient-to-r from-blue-600/20 via-cyan-600/15 to-blue-600/20 rounded-2xl p-8 border border-blue-500/20 text-center mb-8">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="tel:+593999174980" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-700/50 hover:bg-slate-600/50 text-white font-semibold text-sm transition-all border border-slate-600/50">
