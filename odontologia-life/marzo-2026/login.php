...
<title>Informe SEO — Odontologia Life</title>
...
<div class="relative z-10 w-full max-w-md px-6">
    <div class="glass-card glow-ring rounded-2xl p-8 md:p-10">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-xl font-bold text-white mb-1">Informe SEO & Contenido</h1>
            <p class="text-slate-400 text-sm font-medium">Odontologia Life - Otavalo</p>
        </div>
        ...
        <div class="mt-6 text-center">
            <p class="text-slate-500 text-xs leading-relaxed">Este informe es confidencial y de uso exclusivo para Odontologia Life.</p>
        </div>
