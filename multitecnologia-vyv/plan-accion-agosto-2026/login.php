...
<title>Plan de acci&oacute;n &mdash; Multitecnolog&iacute;a VYV</title>
...
<div class="caja">
  ...
  <p class="sub">Plan de acci&oacute;n &mdash; acceso privado</p>
  <?php if ($error): ?><div class="err"><?= htmlspecialchars($error) ?></div><?php endif; ?>
  <form method="POST">
    <label for="password">Clave de acceso</label>
    <input type="password" id="password" name="password" autofocus required>
    <button type="submit">Ver plan de acci&oacute;n</button>
  </form>
