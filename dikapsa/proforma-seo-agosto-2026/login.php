...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($pass === 'Dikapsa-2026') {
        $_SESSION['auth_dikapsa_seo'] = true;
...
<style>
:root{
  --azul:#0087cc; --azul-osc:#00679c; --azul-claro:#7cc4ec;
  --noche:#0a0f16; --gris:#7d8fa3; --hielo:#cbd5e1;
}
*{box-sizing:border-box;margin:0;padding:0}
body{
  font-family:'Outfit',system-ui,sans-serif;
  background:radial-gradient(950px 640px at 28% 10%, rgba(0,135,204,.22), transparent 62%), var(--noche);
...
.caja{
  ...
  border:1px solid rgba(124,196,236,.16); border-radius:18px; padding:44px 38px;
...
.sello svg{width:30px;height:30px;color:#02202f}
.eyebrow{
  font-family:'JetBrains Mono',monospace;font-size:10.5px;font-weight:700;
  letter-spacing:.2em;text-transform:uppercase;color:var(--azul-claro);
...
input{
  ...
  background:rgba(10,15,22,.7);border:1px solid rgba(124,196,236,.18);
  color:#e8eef6;font:inherit;font-size:14.5px;
}
input:focus{outline:none;border-color:var(--azul);box-shadow:0 0 0 3px rgba(0,135,204,.24)}
button{
...
.pie{
  margin-top:26px;padding-top:20px;border-top:1px solid rgba(124,196,236,.12);
...
<div class="caja">
  ...
  <form method="POST">
    ...
    <input id="p" type="password" name="password" placeholder="Ingresa tu clave" required autofocus>
