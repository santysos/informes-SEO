    ...
    <div class="max-w-4xl mx-auto px-6">
        <div class="glass-strong rounded-3xl p-10 md:p-14 text-center border-brand-400/30">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                ...
                <a href="https://wa.me/593967754770?text=Hola%20Santiago%2C%20queremos%20aprobar%20la%20propuesta%20de%20Dikapsa" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white/5 hover:bg-white/10 border border-cyan-400/30 text-white font-bold text-base transition">
