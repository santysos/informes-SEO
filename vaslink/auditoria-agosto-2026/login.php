...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($pass === 'Vaslink-2026') {
        $_SESSION['auth_vaslink_audit'] = true;
...
<style>
:root{
  --azul:#3b82f6; --azul-osc:#2563eb; --azul-claro:#93c5fd;
  --noche:#0a0f16; --carbon:#111a24; --gris:#7d8fa3; --hielo:#cbd5e1;
}
*{box-sizing:border-box;margin:0;padding:0}
body{
  font-family:'Outfit',system-ui,sans-serif;
  background:radial-gradient(950px 640px at 28% 10%, rgba(59,130,246,.20), transparent 62%), var(--noche);
...
.caja{
  ...
  border:1px solid rgba(147,197,253,.16); border-radius:18px; padding:44px 38px;
...
input{
  ...
  background:rgba(10,15,22,.7);border:1px solid rgba(147,197,253,.18);
  color:#e8eef6;font:inherit;font-size:14.5px;
}
input:focus{outline:none;border-color:var(--azul);box-shadow:0 0 0 3px rgba(59,130,246,.22)}
button{
...
.pie{
  margin-top:26px;padding-top:20px;border-top:1px solid rgba(147,197,253,.12);
...
<div class="caja">
  ...
  <h1>Auditoría técnica de vaslinkec.com</h1>
  <p class="sub">Vaslink &middot; 30 de agosto de 2026</p>
  <form method="POST">
    ...
    <button type="submit">Ver el informe</button>
  </form>
