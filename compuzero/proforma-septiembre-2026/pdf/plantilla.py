...
# -*- coding: utf-8 -*-
"""
Genera la cotizacion de tienda en linea de CompuZero en el formato oficial
...
PROFORMA   = "1-2-1328"
CLIENTE    = "CompuZero — Fabián Ortega"
FECHA      = "8 de septiembre de 2026"
VALIDEZ    = "30 días"
COBERTURA  = "3 a 4 semanas"
TELEFONO   = "098 142 3644"
RENOVACION = "ENTREGA EN 3 A 4 SEMANAS"
...
ITEM = fila("a",
    "DESARROLLO DE TIENDA EN L&Iacute;NEA &ndash; CATALOGO DE COMPUTADORAS",
    [
      "Dise&ntilde;o propio para CompuZero, adaptado a celular y tablet",
      "Cat&aacute;logo con buscador y filtros por marca, procesador, memoria y precio",
      "Fichas de producto con especificaciones t&eacute;cnicas y fotograf&iacute;as",
      "Carrito y proceso de pedido; bot&oacute;n de WhatsApp en cada producto",
      "Carga inicial de hasta 60 productos",
      "Dominio .com.ec o .ec por 1 a&ntilde;o y hosting por 1 a&ntilde;o",
      "Certificado de seguridad SSL y correos corporativos",
      "Optimizaci&oacute;n de velocidad e im&aacute;genes",
      "T&iacute;tulos y descripciones para buscadores; medici&oacute;n de visitas",
      "Panel de autogesti&oacute;n, capacitaci&oacute;n y soporte por 1 mes",
    ],
    "1,200.00")

NOTA = ("Forma de pago: 60&nbsp;% al iniciar ($720.00) y 40&nbsp;% a la entrega ($480.00).<br>"
        "No incluye pasarela de pagos en l&iacute;nea, fotograf&iacute;a de producto, redacci&oacute;n de fichas "
        "t&eacute;cnicas, carga sobre 60 productos ni facturaci&oacute;n electr&oacute;nica.<br>"
        "Renovaci&oacute;n desde el segundo a&ntilde;o: hosting $95.99 m&aacute;s el dominio seg&uacute;n su extensi&oacute;n.")

DOCS = {
 "cotizacion": documento(
    PROFORMA, ITEM,
    totales([("Subtotal:", "$ 1,200.00", ""), ("Descuento:", "", ""),
             ("IVA 15%:", "", ""), ("TOTAL:", "$ 1,200.00", "total")]),
    NOTA),
}
