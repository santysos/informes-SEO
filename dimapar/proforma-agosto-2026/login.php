...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($pass === 'Dimapar-2026') {
        $_SESSION['auth_dimapar_prop'] = true;
...
<title>Propuesta &mdash; Dimapar Ecuador</title>
...
<div class="caja">
  ...
  <h1>Sitio web Besser + Plan SEO Dimapar</h1>
  <p class="sub">Dimapar Ecuador &middot; agosto 2026</p>
  <form method="POST">
