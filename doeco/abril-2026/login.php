...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $pass = $_POST['password'] ?? '';
    if ($pass === 'Doeco-SEO-2026') {
        $_SESSION['auth_doeco'] = true;
...
<div class="relative z-10 w-full max-w-md px-6">
    <div class="glass-card glow-ring rounded-2xl p-8 md:p-10">
        ...
        <div class="text-center mb-8">
            ...
            <h1 class="text-xl font-bold text-white mb-1">Informe SEO & Analisis de Marketing Digital</h1>
            <p class="text-slate-400 text-sm font-medium">Doeco — Empaques Ecologicos</p>
        </div>
