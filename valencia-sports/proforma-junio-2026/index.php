...
<header class="no-print-only sticky top-0 z-50 glass-strong border-b border-lime-400/10">
    <div class="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="descargar-pdf.php" class="hidden md:inline-flex items-center gap-2 px-4 py-2 rounded-xl brand-grad text-slate-900 text-sm font-bold transition hover:opacity-90">
    ...
    <div class="max-w-4xl mx-auto px-6">
        <div class="glass-strong rounded-3xl p-10 md:p-14 text-center border-2 border-lime-400/30">
            ...
            <div class="flex flex-wrap justify-center gap-4">
                <a href="descargar-pdf.php" class="inline-flex items-center gap-2 px-8 py-4 rounded-xl brand-grad text-slate-900 font-bold text-base hover:opacity-90 transition shadow-2xl">
                ...
                <a href="https://wa.me/593999174980?text=Hola%20Santiago%2C%20queremos%20aprobar%20la%20propuesta%20del%20ecommerce%20de%20Valencia%20Sports" target="_blank" rel="noopener" class="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white/5 hover:bg-white/10 border border-lime-400/30 text-white font-bold text-base transition">
