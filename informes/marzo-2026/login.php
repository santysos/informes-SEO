...
<head>
    ...
    <title>Informe SEO — Comercial Hidrobo</title>
...
<body class="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="text-center mb-8">
            ...
            <p class="text-slate-400 mt-1">Comercial Hidrobo & OKCars</p>
        </div>
        ...
        <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl">
            ...
            <p class="text-center text-slate-500 text-xs mt-6">Este informe es confidencial y de uso exclusivo para Comercial Hidrobo S.A.</p>
        </div>
