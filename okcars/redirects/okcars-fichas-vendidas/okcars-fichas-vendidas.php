 ...
 * Deepal S05.
 *
 * INSTALACIÓN — sin cPanel
 *   wp-admin → Plugins → Añadir nuevo → Subir plugin → elegir el .zip → Instalar.
 *   La activación la podemos hacer nosotros por API; no hace falta que la hagas.
 * ─────────────────────────────────────────────────────────────────────────────
 */
